    ...
    <div className="bg-[#0A0A0A] min-h-screen">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass-dark">
        <div className="container-luxury flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            <Link href="/admin"
              className="text-white/40 hover:text-white/70 transition-colors text-xs tracking-wider uppercase hidden md:block"
              style={{ fontFamily: 'var(--font-poppins)' }}>
              Admin
            </Link>
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <motion.div className="relative z-10 text-center px-6 max-w-5xl mx-auto" style={{ opacity: heroOpacity }}>
          ...
          <motion.h1
            className="text-6xl md:text-8xl lg:text-[7rem] text-white leading-none mb-6"
            ...
            {features.map((feature, i) => (
              <SectionReveal key={i} delay={i * 0.05}>
                <div className="glass p-6 group hover-lift relative h-full">
                  ...
                  <p className="text-white/40 text-sm leading-relaxed" style={{ fontFamily: 'var(--font-poppins)' }}>
                    {feature.desc}
                  </p>
                </div>
              </SectionReveal>
      ...
      <section id="demo" className="section-padding" style={{ background: '#0D0D0D' }}>
        <div className="container-luxury">
            ...
            <div className="relative max-w-4xl mx-auto group">
              ...
              <div className="glass rounded-sm overflow-hidden luxury-shadow">
                <div className="flex items-center gap-2 px-4 py-3 border-b border-white/5">
                  ...
                  <div className="flex-1 mx-4 bg-white/5 rounded-sm px-3 py-1">
          ...
          <SectionReveal className="mt-12 text-center" delay={0.2}>
            <p className="text-white/30 text-xs mb-4" style={{ fontFamily: 'var(--font-poppins)' }}>
              ...
              <SectionReveal key={i} delay={i * 0.1}>
                <div className="glass p-6 relative hover-lift h-full flex flex-col">
                  ...
                  <div className="flex items-center justify-between">
                    <p className="text-white/70 text-xs font-medium" style={{ fontFamily: 'var(--font-poppins)' }}>
                      {t.name}
                    </p>
                    <p className="text-white/30 text-xs" style={{ fontFamily: 'var(--font-poppins)' }}>
                      {t.date}
            ...
            {plans.map((plan, i) => (
              <SectionReveal key={i} delay={i * 0.1}>
                <div className={`relative p-8 hover-lift h-full flex flex-col ${plan.highlight ? 'border border-[#C9A84C]/40 bg-[#C9A84C]/5' : 'glass'}`}>
                  ...
                  <h3 className="text-2xl text-white mb-1" style={{ fontFamily: 'var(--font-cormorant)', fontStyle: 'italic' }}>
                    {plan.name}
                  </h3>

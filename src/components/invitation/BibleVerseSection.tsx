      ...
      <div className="container-luxury relative z-10 text-center max-w-3xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 1 }}>
          ...
          <div className="flex items-center justify-center mb-8">
            <span className="text-[#1A1410] text-4xl font-bold" style={{ fontFamily: 'var(--font-cormorant)' }}>✝</span>
          </div>

          <GoldDivider className="mb-10" />

          <motion.blockquote
            className="text-[#1A1410] text-2xl md:text-3xl lg:text-4xl leading-relaxed mb-4"
          ...
          <motion.p
            className="text-[#1A1410] text-sm tracking-[0.4em] uppercase mb-12 font-bold"
          ...
          <motion.blockquote
            className="text-[#1A1410] text-lg md:text-xl leading-relaxed mb-4"
            style={{ fontFamily: 'var(--font-cormorant)', fontStyle: 'italic', fontWeight: 500 }}
          ...
          <motion.p
            className="text-[#1A1410] text-xs tracking-[0.3em] uppercase font-bold"
            style={{ fontFamily: 'var(--font-poppins)' }}

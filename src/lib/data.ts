...
export const pieterFebriyantiData: InvitationData = {
    ...
    story: [
      {
        ...
        description: 'Dua jiwa yang dipertemukan oleh takdir. Sebuah pertemuan sederhana yang ternyata menjadi awal dari segalanya.',
        image: '/EL_06253.png',
      },
      {
        date: 'Mengenal Lebih Dekat',
        title: 'Semakin Dekat',
        description: 'Hari demi hari, percakapan demi percakapan — kami semakin mengenal satu sama lain dan menemukan kecocokan yang luar biasa.',
        image: '/EL_06140.png',
      },
      {
        date: 'Resmi Bersama',
        title: 'Menjalin Hubungan',
        description: 'Dengan restu keluarga dan keyakinan di hati, kami memutuskan untuk melangkah bersama dalam satu ikatan yang tulus.',
        image: '/IMG_2438.JPEG',
      },
      {
        date: 'Lamaran',
      ...
      },
      {
        ...
        description: 'Hari ini, di hadapan Tuhan, keluarga, dan orang-orang terkasih — kami mengucapkan janji suci untuk selamanya.',
        image: '/IMG_2437.JPEG',
      },
    ],
  },
  gallery: [
    ...
    { id: '2',  url: '/EL_06104.png',      caption: 'Bersama',          width: 800, height: 1000 },
    { id: '3',  url: '/EL_06120.png',      caption: 'Momen Indah',      width: 800, height: 1000 },
    { id: '4',  url: '/EL_06122.png',      caption: 'Cinta Kami',       width: 800, height: 1000 },
    { id: '5',  url: '/EL_06140.png',      caption: 'Kebersamaan',      width: 800, height: 1000 },
    { id: '6',  url: '/EL_06253.png',      caption: 'Senja Berdua',     width: 800, height: 1000 },
    { id: '7',  url: '/EL_06256.png',      caption: 'Kenangan',         width: 800, height: 1000 },
    { id: '8',  url: '/EL_06284.png',      caption: 'Bahagia',          width: 800, height: 1000 },
    { id: '9',  url: '/EL_06301.png',      caption: 'Cinta Sejati',     width: 800, height: 1000 },
    { id: '10', url: '/IMG_2012.JPG.jpeg', caption: 'Momen Spesial',    width: 800, height: 1000 },
    { id: '11', url: '/IMG_2436.JPEG',     caption: 'Indah',            width: 800, height: 1000 },
    { id: '12', url: '/IMG_2437.JPEG',     caption: 'Bersama Selalu',   width: 800, height: 1000 },
    { id: '13', url: '/IMG_2438.JPEG',     caption: 'Selamanya',        width: 800, height: 1000 },
  ],
  wishes: [],
  gifts: [
    {
